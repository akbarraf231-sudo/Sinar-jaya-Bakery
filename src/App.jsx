...
const Home = ({products,onCat,onProd,cart,onCart,heroBg,loading,onTrack}) => {
  ...
  return(<Shell>
    <div className={`text-white px-6 pt-14 pb-12 text-center relative overflow-hidden ${!heroBg?"bg-gradient-to-br from-amber-800 via-amber-900 to-stone-900":""}`} style={hs}>
      <div className="relative z-10"><p className="text-amber-200/80 text-xs tracking-[0.2em] uppercase mb-3 font-medium">Homemade Bakery</p><h1 className="text-3xl font-bold mb-2 tracking-tight">Sinar Jaya Bakery</h1><p className="text-amber-100/70 text-sm mb-6 max-w-xs mx-auto leading-relaxed">Menyempurnakan setiap momen spesial dengan kue buatan tangan penuh cinta</p>
        <div className="flex justify-center gap-6 mb-8 text-amber-100/80 text-xs"><span>🌿 Fresh Daily</span><span>🎨 Custom Order</span><span>❤️ Homemade</span></div>
    ...
    {loading?<Skel/>:(<div className="px-5 py-8"><div className="flex items-center gap-2 mb-4"><div className="w-8 h-[2px] bg-amber-300 rounded-full"/><h2 className="font-bold text-stone-800 text-lg">Favorit Pelanggan</h2></div>
